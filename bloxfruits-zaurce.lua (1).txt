if game.PlaceId == 2753915549 or game.PlaceId == 4442272183 or game.PlaceId == 7449423635 then
    _G.Color = Color3.fromRGB(25,255,190)
                ...
                if not isnil(v.Character) then
                    if not v.Character.Head:FindFirstChild('NameEsp'..v.Name) then
                        ...
                        if v.Team == game:GetService("Players").LocalPlayer.Team then
                            ...
                            ESP.TextColor3 = Color3.new(25, 255, 190)
                        end
                        ESP.TextSize = 14
                        ...
                        HealthESP.TextColor3 = Color3.fromRGB(25, 255, 190)
                ...
                if DevilFruitESP then
                    if string.find(v.Name, "Fruit") then   
                        if not v.Handle:FindFirstChild('NameEsp'..Number) then
                            ...
                            name.BackgroundTransparency = 1
                            name.TextStrokeTransparency = 0.5
                            name.TextColor3 = Color3.fromRGB(25, 255, 190)
    ...
    --------------------------------------------------------------------gg
    local RenUi = library:AddWindow("Euphoria HUB | BF",Enum.KeyCode.RightControl)
    -------------------------------------------hj-------------------------
...
elseif game.PlaceId == 4520749081 or game.PlaceId == 6381829480 or game.PlaceId == 5931540094 or game.PlaceId == 5931540094 then
    ...
    function library:AddWindow(text,keybind)
        ...
        function uitab:AddTab(text,image)
            ...
            TuglosCorner.CornerRadius = UDim.new(0, 5)
		       TuglosCorner.Name = "TuglosCorner"
		       TuglosCorner.Parent = PageButton
    ...
    --
    local RenUi = library:AddWindow("Euphoria HUB | KL",Enum.KeyCode.RightControl)
    --
    local Main = RenUi:AddTab("Auto Farm","6026568198")
    local Stats = RenUi:AddTab("Stats","7040410130")
    local Combat = RenUi:AddTab("Combat","7251993295")
...
elseif game.PlaceId == 6329844902 then
    ...
    --
    local RenUi = library:AddWindow("Euphoria HUB | LP",Enum.KeyCode.RightControl)
    --
    local Main = RenUi:AddTab("Auto Farm","6026568198")
    local Stats = RenUi:AddTab("Stats","7040410130")
    local Combat = RenUi:AddTab("Combat","7251993295")
